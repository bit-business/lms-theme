...
namespace NadzorServera\Skijasi\Theme\LMSTheme\Commands;
...
class LMSThemeSetup extends Command
{
     ...
     * @var string
     */
    protected $name = 'skijasi-lms-theme:setup';
     ...
     * @var string
     */
    protected $description = 'Setup Skijasi LMS Theme';
    ...
    {
        Artisan::call('vendor:publish', ['--tag' => 'SkijasiLMSTheme']);

        $this->info('Skijasi lms theme provider published');
    }
    ...
    protected function updateWebpackMix()
    {
        ...
        mix.js(
            "package/skijasi/lms-theme/src/resources/app/app.js",
            "public/js/lms-theme.js"
        )
            .vuetify("vuetify-loader", { postCss: true })
            .postCss(
                "package/skijasi/lms-theme/src/resources/css/app.css",
    ...
    {
        return [
            'POST_THEME_PREFIX' => 'lms',
        ];
    }

    protected function addSkijasiEnv()
    {
        try {
